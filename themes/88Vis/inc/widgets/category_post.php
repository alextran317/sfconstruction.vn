<?php
class LMCIT_Theme_Widget_Category_Post extends WP_Widget{
	
	public function __construct() {
		
		$id_base = 'lmcit-widget-category-post';
		$name	= 'Category post';
	...
	public function widget( $args, $instance ) {
        ...
        if($instance['type'] == 0 || !isset($instance['type'])) {
			require LMCIT_THEME_WIDGET_DIR . '/html/category_post.php';
        } elseif($instance['type'] > 0) {
			require LMCIT_THEME_WIDGET_DIR . '/html/category_post_' . $instance['type'] . '.php';
        }
